...
public class Student {// Create our class Student
    ...
    // because how much more cohesion you class have(what's means that your class do little things, most recomended is that the class only do
    // one thing), highly maintainable code it's bring to you

    // never do things like this, chose in other hands create a new Class for the Professor objects
    // public String nameProfessor = "Zoro";
    // public int ageProfessor;
    // public char genderProfessor;
    // this is a bad cohesion

    // Another practice of bad cohesion is put the method main inside our class(which have the only purpose that create objects in other files)
    //public static void main(String[] args) {
    //    
    //}

    // always alocate your class in files separeted the file which going execute the whole thing(that has the psvm)
}
