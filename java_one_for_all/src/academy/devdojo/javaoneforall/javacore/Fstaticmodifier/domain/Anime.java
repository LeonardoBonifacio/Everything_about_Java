...
public class Anime {
    ...
    // and if we have another init block non-static he will be executed everytime
    ...
    static {// static init blocks are executed only once
            // the diference between the init block static and non-static is basic the word
    ...
    // if we have more than one init block static they will be executed once in the
    // order they appear
    static {
