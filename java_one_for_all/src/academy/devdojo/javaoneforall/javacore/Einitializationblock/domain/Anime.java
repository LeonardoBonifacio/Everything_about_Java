...
public class Anime {
    ...
    // initizalization blocks always will being executed , the initialization block
    // is like a constructor which ever is call
...

    {
        ...
        // doesn't matter the position of this init block it will be executed first
        // every time that one object is created
    ...
    // have more than one constructor sometimes can be confused if anything of the
    // variables of the class/object was initialize or not
    public Anime() {
