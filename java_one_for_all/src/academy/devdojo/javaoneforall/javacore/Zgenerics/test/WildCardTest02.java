...
public class WildCardTest02 {
    public static void main(String[] args) {
        ...
        printConsultExtendAnimal(dogs);
        printConsultExtendAnimal(cats);
        printConsultExtendAnimal(animals);
    ...
    // especifc Type of Animal and below in your inheritance Tree(in this Case only
    // Cat or Dog or Animal)
    // Animal to below, only class which has Animal as superClass or Class Animal
    // itself
    ...
    // polimorphism)
    private static void printConsultExtendAnimal(List<? extends Animal> animals) {
    ...
    // here i'm telling for the method that i accept one list of Dog or Objects or
    // Animal(the superClass of Dog)
    ...
    private static void printConsulDog(List<? super Dog> animals) {
        ...
        // but because i don't know for sure what kinda of list this is (could be Simply
        // Object or Animal)
    ...
    // here i'm telling for the method that i accept one Animal or Object(that is
    // the superClass of Animal)
    // nothing above animal(like Cat or Dog)
    private static void printConsultSuperAnimal(List<? super Animal> animals) {
        System.out.println("-----------");
