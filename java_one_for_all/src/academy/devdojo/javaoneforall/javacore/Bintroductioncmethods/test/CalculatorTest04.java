...
public class CalculatorTest04 {
    public static void main(String[] args) {
        ...
        // Everytime you send a primitive type as an argument you are actually sending a
        // copy of its value, you never send a reference to that variable
        // Scope Global/local of method main
        // in each Scope we have diference spaces in memory for each variable, which not
        // affect each other
