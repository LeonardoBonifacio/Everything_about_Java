...
public class CalculatorTest05 {
    public static void main(String...args) {
        ...
        // calculator.sumArray(int[] {1, 2, 3, 4, 7, 8}) we an sending an array like this
        calculator.sumArray(numbers);
        calculator.sumVarArgs(1, 2, 3, 4, 7, 8 );// passing arguments in which methods that receive varArgs
