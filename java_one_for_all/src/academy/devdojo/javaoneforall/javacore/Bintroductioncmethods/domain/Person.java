...
public class Person {
    private String name;
    private int age;
    // keyword private means nobody besides this class and this object will have access to these atributtes
    // and for allow the object to access this atribbutes we have to create methods(set and get)
