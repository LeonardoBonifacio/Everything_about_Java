...
public class Calculator {
    ...
    // syntax of methods
    // acess modifier(public, private) which is going to return(void, primitive
    // types and reference types) name of method(camelCase) parenthesis(){
    // }
    ...
    // when one method return something, we need to define which type of the
    // something is going to return
    ...
    public void printTwoNumbersDivided(double number1, double number2) {
        if (number2 == 0) {
            ...
            return;
            // you can use return like a break only inside void methods, because these
            // methods don't return nothing
